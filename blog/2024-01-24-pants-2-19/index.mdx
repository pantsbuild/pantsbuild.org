...
<CaptionedImg src={require("./splash.jpeg").default}>
  Photo by [Erol Ahmed](https://unsplash.com/@erol?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash)
  /
...
Keep reading to see more, or check the [full changelog](https://github.com/pantsbuild/pants/tree/main/src/python/pants/notes/2.19.x.md). Pants is an open-source project, and the below changes are all contributed by our community. If you want to see something more in the next changelog, join us on [GitHub](https://github.com/pantsbuild/pants) and become a contributor.
...
This functionality can be added to any other language with fairly little work. Do you want automatic retries for Scala, Go, or another language Pants supports? Come chat to us in [#development with Slack](https://pantsbuild.slack.com).
