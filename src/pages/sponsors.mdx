...
<br></br>
<CaptionedImg src={require("./sponsor_logos/depot.png").default}></CaptionedImg>

[Depot](https://depot.dev/) provides accelerated compute, distributed caching, and observability for CI/CD workflows, integrated with build tools like Pants. In fact, Pants uses Depot for its own CI!
...
<br></br>
<CaptionedImg
  src={require("./sponsor_logos/exoflare.png").default}
></CaptionedImg>

[ExoFlare](https://www.exoflare.io/open-source/) is building the world’s first industrial scale biosecurity platform for intensive animal and food production sectors.
