...
BUT if you do, you will want to make note of [#9946](https://github.com/pantsbuild/pants/pull/9946) and configure `pantsd` to restart for edits to the non-standard filename.
:::
