...
Use [`./pants tailor ::`](../../getting-started/getting-started/initial-configuration.mdx#5-generate-build-files) to automate generating BUILD files, and [`./pants update-build-files ::`](../../../reference/goals/update-build-files.mdx) to reformat them (using `black`, [by default](../../../reference/goals/update-build-files.mdx#section-formatter)).
