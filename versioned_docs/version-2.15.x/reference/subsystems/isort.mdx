...
If true, don&#x27;t use isort when running `/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 fmt` and `/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 lint`.
...
If true, export a virtual environment with isort when running `/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 export`.
