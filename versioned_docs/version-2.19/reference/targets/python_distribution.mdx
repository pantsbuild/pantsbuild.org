...
See https://www.pantsbuild.org/v2.19/docs/python-distributions.
...
See https://www.pantsbuild.org/v2.19/docs/plugins-setup-py for how to write a plugin to dynamically generate kwargs.
