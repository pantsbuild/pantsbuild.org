...
If true, don&#x27;t use pyupgrade when running `/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 fmt` and `/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 lint`.
...
<Option
  ...
  default_repr={`pyupgrade>=2.33.0,<2.35`}
>
