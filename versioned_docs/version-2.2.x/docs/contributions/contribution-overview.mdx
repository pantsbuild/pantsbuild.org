...
Pants uses [readme.com](https://readme.com/) for the documentation at [pantsbuild.org](https://pantsbuild.org). On any of these docs pages, you can click "Suggest Edits" at the top right corner in order to be dropped into the editor interface. You will be asked to log in or sign up to readme.com, which only asks for your email address and a name to call you.
...
To share your plan, please either open a [GitHub issue](https://github.com/pantsbuild/pants/issues) or message us on [Slack](/community/members#slack) (you can start with the #general channel). Briefly describe the change you'd like to make, including a motivation for the change.
...
We use Travis CI for continuous integration. Look for your build in https://travis-ci.com/github/pantsbuild/pants/pull_requests.
