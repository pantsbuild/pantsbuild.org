...
The default `sources` value for the `python_test_utils` target includes `conftest.py`. You can run [`./pants tailor`](../../getting-started/create-initial-build-files.mdx) to automatically add this target:
