...
known_versions = [
  ...
  default_repr={`[\n  "v2.79.0|macos_x86_64|f7a50bfb31c2304f4b30ef6eabb623c86abae0b5841dc3d8a147afd1568ecd4e|4940234",\n  "v2.79.0|macos_arm64|f7a50bfb31c2304f4b30ef6eabb623c86abae0b5841dc3d8a147afd1568ecd4e|4940234",\n  "v2.79.0|linux_x86_64|f7a50bfb31c2304f4b30ef6eabb623c86abae0b5841dc3d8a147afd1568ecd4e|4940234",\n  "v2.79.0|linux_arm64|f7a50bfb31c2304f4b30ef6eabb623c86abae0b5841dc3d8a147afd1568ecd4e|4940234"\n]`}
>
...
URL to download the tool, either as a single binary file or a compressed file (e.g. zip file). You can change this to point to your own hosted file, e.g. to work with proxies or for access via the filesystem through a `file:$abspath` URL (e.g. `file:/this/is/absolute`, possibly by [templating the buildroot in a config file](https://www.pantsbuild.org/2.31/docs/using-pants/key-concepts/options#config-file-entries)).
