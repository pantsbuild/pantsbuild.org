...
If set, lockfile headers will say to run this command to regenerate the lockfile, rather than running `/home/josh/work/scie-pants/dist/pants generate-lockfiles --resolve=<name>` like normal.
