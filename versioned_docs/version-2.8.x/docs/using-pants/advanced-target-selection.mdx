...
See [File arguments vs. target arguments](./key-concepts-to-know-about-pants/goals.mdx#file-arguments-vs-target-arguments) for the normal techniques for telling Pants what to run on.
