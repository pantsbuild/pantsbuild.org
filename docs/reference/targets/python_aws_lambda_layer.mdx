...
See https://www.pantsbuild.org/2.34/docs/python/integrations/aws-lambda.
...
<Field
    type_repr={`'python3.10' | 'python3.11' | 'python3.12' | 'python3.13' | 'python3.14' | 'python3.6' | 'python3.7' | 'python3.8' | 'python3.9' | None`}
    default_repr={`None`}
>
