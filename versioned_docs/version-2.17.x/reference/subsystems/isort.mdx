...
If true, don&#x27;t use isort when running `scie-pants-linux-x86_64 fmt` and `scie-pants-linux-x86_64 lint`.
...
If true, export a virtual environment with isort when running `scie-pants-linux-x86_64 export`.
