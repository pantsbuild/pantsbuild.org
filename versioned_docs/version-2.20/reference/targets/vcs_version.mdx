...
If you need functionality that is not currently exposed here, please reach out to us at https://www.pantsbuild.org/v2.20/docs/getting-help.
...
The local scheme to configure `setuptools_scm` to use. See https://setuptools-scm.readthedocs.io/en/latest/extending/#available-implementations_1
...
The version scheme to configure `setuptools_scm` to use. See https://setuptools-scm.readthedocs.io/en/latest/extending/#available-implementations
