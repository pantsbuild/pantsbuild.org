...
- 🏭 Plugins can now choose to execute processes directly in the workspace, instead of in a sandbox. This is useful for running heavyweight processes (such as shelling out to another build system) without having to construct a massive amount of state in a sandbox.
