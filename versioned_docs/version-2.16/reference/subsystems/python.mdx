...
<Option
  cli_repr={`--python-pip-version=<PipVersion>`}
  env_repr='PANTS_PYTHON_PIP_VERSION'
  one_of='20.3.4-patched, 22.2.2, 22.3, 22.3.1, 23.0, 23.0.1'
  default_repr={`20.3.4-patched`}
>
