...
Options to control the overall behavior of Pants.x
...
- `experimental:file://`, `experimental:github-actions-cache+http://`, `experimental:github-actions-cache+https://`: Remote execution is not supported.
