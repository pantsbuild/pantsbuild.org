...
See [File arguments vs. target arguments](./concepts/goals.mdx#file-arguments-vs-target-arguments) for the normal techniques for telling Pants what to run on.
