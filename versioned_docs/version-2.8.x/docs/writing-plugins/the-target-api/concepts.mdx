...
As described in [Targets and BUILD files](../../using-pants/key-concepts-to-know-about-pants/targets-and-build-files.mdx), a _target_ is an _addressable_ set of metadata describing some of your code.
