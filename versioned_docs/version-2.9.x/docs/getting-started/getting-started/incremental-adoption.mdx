...
To get [tests](../../python/goals/test.mdx) working, you will first need to set up [source roots](../../using-pants/key-concepts/source-roots.mdx) and [third-party dependencies](../../python/overview/third-party-dependencies.mdx). We recommend setting up a lockfile for reproducibility and better performance.
