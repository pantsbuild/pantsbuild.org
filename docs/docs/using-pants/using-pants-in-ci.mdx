...
:::note[Examples]
See the example-python repository for an [example GitHub Actions workflow](https://github.com/pantsbuild/example-python/blob/main/.github/workflows/pants.yaml).
:::
