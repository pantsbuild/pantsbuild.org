...
When [writing plugins](../writing-plugins/plugins-overview.mdx), Pants is used as a _library_, rather than a _binary_. That is, you import Pants code to write plugins. We try to make this API stable for your plugins.
