...
- Pants [ships](page:language-support) with support for [Python](../python/overview/index.mdx), [Go](../go/overview.mdx), [Java](../java-and-scala/overview.mdx), [Scala](../java-and-scala/overview.mdx) and [Shell](../shell/overview.mdx).
...
- Pants can create standalone binaries, [Docker images](../docker/overview.mdx), AWS Lambdas and GCP Cloud Functions
