...
To instead load third-party plugins, add them to a custom resolve alongside flake8 itself, as described in https://www.pantsbuild.org/2.21/docs/python/overview/lockfiles#lockfiles-for-tools.
