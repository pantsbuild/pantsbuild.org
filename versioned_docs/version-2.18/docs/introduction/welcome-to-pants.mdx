...
- Pants [ships](page:language-support) with support for [Python](../python/python-overview/index.mdx), [Go](../go/index.mdx), [Java](../java-and-scala/index.mdx), [Scala](../java-and-scala/index.mdx) and [Shell](../shell/shell-overview.mdx).
