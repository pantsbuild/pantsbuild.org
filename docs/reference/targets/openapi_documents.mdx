...
<Field
    ...
    default_repr={`None`}
    backend="pants.backend.experimental.openapi.codegen.python"
>

Additional properties for python generator
...
If true, skips generation of Python sources from this target
