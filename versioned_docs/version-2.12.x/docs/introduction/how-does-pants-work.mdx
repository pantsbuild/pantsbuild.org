...
With the [Pants plugin API](../writing-plugins/plugins-overview.mdx), your custom rules will run with the same concurrency, caching, and remoting semantics as the core rules.
