...
If a particular SHA does not have built wheels, you can either wait for [the next release from the relevant branch](../../contributions/releases/release-strategy.mdx), ping a maintainer [in Slack](/community/getting-help), or file a Github issue mentioning the SHA that you would like to test.
