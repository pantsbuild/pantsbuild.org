...
description: Analyses K8S manifests rendered by Helm.
---
...
Config section: <span className="color--primary">`[helm-k8s-parser]`</span>
...
<Option
  cli_repr={`--helm-k8s-parser-install-from-resolve=<str>`}
  env_repr='PANTS_HELM_K8S_PARSER_INSTALL_FROM_RESOLVE'
  toml_repr={`[helm-k8s-parser]
...
<Option
  cli_repr={`--helm-k8s-parser-requirements="['<str>', '<str>', ...]"`}
  env_repr='PANTS_HELM_K8S_PARSER_REQUIREMENTS'
  toml_repr={`[helm-k8s-parser]
requirements = [
    '<str>',
    '<str>',
...
<Option
  cli_repr={`--helm-k8s-parser-interpreter-constraints="['<str>', '<str>', ...]"`}
  env_repr='PANTS_HELM_K8S_PARSER_INTERPRETER_CONSTRAINTS'
  toml_repr={`[helm-k8s-parser]
interpreter_constraints = [
    '<str>',
    '<str>',
...
<Option
  cli_repr={`--helm-k8s-parser-version=<str>`}
  env_repr='PANTS_HELM_K8S_PARSER_VERSION'
  toml_repr={`[helm-k8s-parser]
version = <str>`}
  default_repr={`hikaru==0.11.0b`}
...
<Option
  cli_repr={`--helm-k8s-parser-extra-requirements="['<str>', '<str>', ...]"`}
  env_repr='PANTS_HELM_K8S_PARSER_EXTRA_REQUIREMENTS'
  toml_repr={`[helm-k8s-parser]
extra_requirements = [
    '<str>',
    '<str>',
