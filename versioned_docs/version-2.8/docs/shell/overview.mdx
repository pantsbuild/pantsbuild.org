...
Then, run [`./pants tailor`](../getting-started/create-initial-build-files.mdx) to generate BUILD files:
...
2. Create a `shunit2_test` or `shunit2_tests` target in the directory's BUILD file.
   - You can run [`./pants tailor`](../getting-started/create-initial-build-files.mdx) to automate this step.
