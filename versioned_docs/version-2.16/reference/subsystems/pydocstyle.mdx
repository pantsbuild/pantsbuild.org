...
If true, don&#x27;t use Pydocstyle when running `scie-pants-linux-x86_64 lint`.
...
If true, export a virtual environment with Pydocstyle when running `scie-pants-linux-x86_64 export`.
