...
```bash
$ ./pants dependencies helloworld/util:util
//:setuptools
//:translate
...
```bash
$ ./pants dependencies --transitive helloworld/util:util
//:protobuf
//:requirements.txt
//:setuptools
//:translate
...
```bash
$ ./pants dependencies --type=3rdparty helloworld/util:util
setuptools>=42.0.0
translate>=3.2.1
```
...
```bash
$ ./pants dependees helloworld/util:util
helloworld:config
...
```bash
$ ./pants dependees --transitive helloworld/util:util
helloworld:config
...
```bash
$ ./pants dependees --closed helloworld/util:util
helloworld:config
helloworld/greet:greet
helloworld/util:tests
...
```
$ ./pants dependees --output-format=json helloworld/util:util helloworld/protos:protos
{
    "helloworld/protos:protos": [
        "helloworld/util:util",
        "helloworld:config"
...
```bash
$ ./pants filedeps helloworld/util:util
