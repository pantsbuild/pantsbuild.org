...
See https://www.pantsbuild.org/v2.20/docs/python-test-goal
...
<div aria-hidden="true" style={ { visibility: 'hidden', height: 0 } }>
###### {#codebatch_compatibility_tagcode}
</div>
...
You can include anything that can be built by `scie-pants-linux-x86_64 package`, e.g. a `pex_binary`, `python_aws_lambda_function`, or an `archive`.
...
See https://www.pantsbuild.org/v2.20/docs/python-interpreter-compatibility for how these interpreter constraints are merged with the constraints of dependencies.
...
<div aria-hidden="true" style={ { visibility: 'hidden', height: 0 } }>
###### {#codeskip_add_trailing_commacode}
</div>
