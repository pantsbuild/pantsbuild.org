...
See [Adopting Pants in an Existing Repo](../../learn-about-pants/getting-started/incremental-adoption.mdx) for tips on setting up Pants, including where to add BUILD files.
:::
