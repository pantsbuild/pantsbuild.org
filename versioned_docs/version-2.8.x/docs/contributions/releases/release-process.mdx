...
The first weekly dev release for the 2.9 series is now available [on PyPI](https://pypi.org/project/pantsbuild.pants/2.9.0.dev0/).

See the changelog [here](https://github.com/pantsbuild/pants/blob/main/src/python/pants/notes/2.8.x.md).
...
The second release candidate for 2.9.0 is now available [on PyPI](https://pypi.org/project/pantsbuild.pants/2.9.0rc1/).

See the changelog [here](https://github.com/pantsbuild/pants/blob/main/src/python/pants/notes/2.9.x.md).
...
See our [blog post](https://blog.pantsbuild.org/introducing-pants-build-2-9-0/) summarizing the release series, or the more detailed changelog [here](https://github.com/pantsbuild/pants/blob/main/src/python/pants/notes/2.9.x.md).
