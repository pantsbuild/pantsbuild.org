...
See https://www.pantsbuild.org/2.34/docs/python/overview/building-distributions.
...
See https://www.pantsbuild.org/2.34/docs/writing-plugins/common-plugin-tasks/custom-python-artifact-kwargs for how to write a plugin to dynamically generate kwargs.
