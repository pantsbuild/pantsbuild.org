...
PEX files are self-contained executable files that contain a complete Python environment capable of running the target. For more information, see https://www.pantsbuild.org/v2.20/docs/pex.
...
<div aria-hidden="true" style={ { visibility: 'hidden', height: 0 } }>
###### {#codevenv_site_packages_copiescode}
</div>
