...
If true, don&#x27;t use Pylint when running `/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 lint`.
...
<Option
  ...
  default_repr={`pylint>=2.13.0,<2.15`}
>
...
If true, export a virtual environment with Pylint when running `/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 export`.
