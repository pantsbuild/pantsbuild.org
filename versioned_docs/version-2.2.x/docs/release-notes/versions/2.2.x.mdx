...
- _NB_: Unfortunately, the `2.2.x` series currently contains a fairly rare crash that reports: "`thread panicked while processing panic. aborting.`". If you experience this issue, the Pants developers would love your help in capturing a trace! Please see [#11364](https://github.com/pantsbuild/pants/issues/11364).
- Added dependency inference for Python imports of Protobuf, along with Protobuf imports of Protobuf. See [Protobuf and gRPC](../../codegen/protobuf-and-grpc.mdx).
