...
See https://www.pantsbuild.org/2.28/docs/python/integrations/aws-lambda.
...
See https://www.pantsbuild.org/2.28/docs/python/overview/pex#generating-the-complete_platforms-file for details on how to create this file.
