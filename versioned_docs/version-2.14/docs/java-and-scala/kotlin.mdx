...
To override the default on a particular target, you can use the [`jdk=` field](../../reference/targets/kotlin_source.mdx#jdk).
...
the [`resolve` field](../../reference/targets/kotlin_junit_test.mdx#resolve) of any targets which should be used with the
...
[`jvm_artifact` docs](../../reference/targets/jvm_artifact.mdx#packages) for more information.
:::
