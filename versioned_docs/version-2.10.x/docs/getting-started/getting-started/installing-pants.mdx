...
First, set up a minimal `pants.toml` config file to instruct the script to download the latest 2.10 release:
...
You should check the `./pants` script into your repo so that all users can easily install Pants.
:::
