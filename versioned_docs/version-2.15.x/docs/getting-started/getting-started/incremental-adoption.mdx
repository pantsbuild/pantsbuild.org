...
You can use `pants package` to package your code into various formats, such as a [PEX binary](../../python/goals/package.mdx), a [wheel](../../python/python-overview/building-distributions.mdx), an [AWS Lambda](../../python/integrations/aws-lambda.mdx), or a [zip/tar archive](../../using-pants/assets-and-archives.mdx).
