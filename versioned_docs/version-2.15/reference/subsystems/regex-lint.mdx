...
<Option
  cli_repr={`--[no-]regex-lint-skip`}
  env_repr='PANTS_REGEX_LINT_SKIP'
  default_repr={`False`}
>

If true, don&#x27;t use regex-lint when running `/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 lint`.
