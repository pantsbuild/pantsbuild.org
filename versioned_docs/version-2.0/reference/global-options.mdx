...
<Option
  ...
  toml_repr={`[GLOBAL]
pants_configdir = <dir>`}
  default_repr={`/home/josh/.config/pants`}
>
...
<Option
  cli_repr={`--[no-]pants-distdir-legacy-paths`}
  env_repr='PANTS_DISTDIR_LEGACY_PATHS'
  toml_repr={`[GLOBAL]
...
<Option
  cli_repr={`--remote-execution-process-cache-namespace=<str>`}
  env_repr='PANTS_REMOTE_EXECUTION_PROCESS_CACHE_NAMESPACE'
  toml_repr={`[GLOBAL]
...
<Option
  cli_repr={`--[no-]allow-external-binary-tool-downloads`}
  env_repr='PANTS_ALLOW_EXTERNAL_BINARY_TOOL_DOWNLOADS'
  toml_repr={`[GLOBAL]
...
<Option
  cli_repr={`--backend-packages2="['<str>', '<str>', ...]"`}
  env_repr='PANTS_BACKEND_PACKAGES2'
  toml_repr={`[GLOBAL]
backend_packages2 = [
    '<str>',
    '<str>',
...
<Option
  cli_repr={`--binaries-baseurls="['<str>', '<str>', ...]"`}
  env_repr='PANTS_BINARIES_BASEURLS'
  toml_repr={`[GLOBAL]
binaries_baseurls = [
    '<str>',
    '<str>',
...
<Option
  cli_repr={`--binaries-fetch-timeout-secs=<int>`}
  env_repr='PANTS_BINARIES_FETCH_TIMEOUT_SECS'
  toml_repr={`[GLOBAL]
...
<Option
  cli_repr={`--binaries-path-by-id="{'key1': val1, 'key2': val2, ...}"`}
  env_repr='PANTS_BINARIES_PATH_BY_ID'
  toml_repr={`[GLOBAL.binaries_path_by_id]
key1 = val1
key2 = val2
...`}
  default_repr={`{}`}
...
<Option
  cli_repr={`--[no-]dependency-inference`}
  env_repr='PANTS_DEPENDENCY_INFERENCE'
  toml_repr={`[GLOBAL]
...
<Option
  cli_repr={`--option-name-check-distance=<int>`}
  env_repr='PANTS_OPTION_NAME_CHECK_DISTANCE'
  toml_repr={`[GLOBAL]
...
<Option
  cli_repr={`--pantsd-log-dir=<str>`}
  env_repr='PANTS_PANTSD_LOG_DIR'
  toml_repr={`[GLOBAL]
pantsd_log_dir = <str>`}
  default_repr={`None`}
  removal_version='2.1.0.dev0'
...
<Option
  cli_repr={`--plugins2="['<str>', '<str>', ...]"`}
  env_repr='PANTS_PLUGINS2'
  toml_repr={`[GLOBAL]
plugins2 = [
    '<str>',
    '<str>',
...
<Option
  cli_repr={`--[no-]print-exception-stacktrace`}
  env_repr='PANTS_PRINT_EXCEPTION_STACKTRACE'
  toml_repr={`[GLOBAL]
...
<Option
  cli_repr={`--[no-]remote-execution-enable-streaming`}
  env_repr='PANTS_REMOTE_EXECUTION_ENABLE_STREAMING'
  toml_repr={`[GLOBAL]
...
<Option
  cli_repr={`--spec-file="['<str>', '<str>', ...]"`}
  env_repr='PANTS_SPEC_FILE'
  toml_repr={`[GLOBAL]
spec_file = [
    '<str>',
    '<str>',
