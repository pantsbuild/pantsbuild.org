...
If true, don&#x27;t use yapf when running `/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 fmt` and `/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 lint`.
...
If true, export a virtual environment with yapf when running `/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 export`.
