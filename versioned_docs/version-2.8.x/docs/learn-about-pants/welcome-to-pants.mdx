...
Pants is in a similar category as tools such as `make`, `ant`, `maven`, `gradle`, `sbt`, `bazel` and others. Its design leans on ideas and inspiration from these earlier tools, while optimizing for speed, correctness, and ergonomics in today's real-world use cases.
...
Pants ships with support for Python, Shell, Docker, and Go. Support for other languages, including Java, Scala, and more is [coming soon](page:language-support).
