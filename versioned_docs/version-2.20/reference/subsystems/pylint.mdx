...
To instead load third-party plugins, add them to a custom resolve alongside pylint itself, as described in https://www.pantsbuild.org/2.20/docs/python/overview/lockfiles#lockfiles-for-tools.
