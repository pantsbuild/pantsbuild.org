...
- Add [`instructions` field](https://www.pantsbuild.org/v2.9/docs/reference-docker_image#instructions) to `docker_image` to support generating an anonymous Dockerfile from scratch.
...
- Add new [`secrets` field](https://www.pantsbuild.org/v2.9/docs/reference-docker_image#secrets) to `docker_image`.
