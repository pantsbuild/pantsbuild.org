...
<Option
  cli_repr={`--mypy-protobuf-install-from-resolve=<str>`}
  env_repr='PANTS_MYPY_PROTOBUF_INSTALL_FROM_RESOLVE'
  toml_repr={`[mypy-protobuf]
...
<Option
  cli_repr={`--mypy-protobuf-requirements="['<str>', '<str>', ...]"`}
  env_repr='PANTS_MYPY_PROTOBUF_REQUIREMENTS'
  toml_repr={`[mypy-protobuf]
requirements = [
    '<str>',
    '<str>',
...
<Option
  ...
  toml_repr={`[mypy-protobuf]
version = <str>`}
  default_repr={`mypy-protobuf==3.4.0`}
