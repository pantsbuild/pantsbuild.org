...
If set to true, do not push this Helm chart to registries when running `scie-pants-linux-x86_64 publish`.
...
If set to true, do not run any linting in this Helm chart when running `scie-pants-linux-x86_64 lint`.
