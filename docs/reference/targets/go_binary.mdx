...
Import path of the package with the `main` for this binary, e.g. `main_import_path="github.com/some/tool/cmd/tool"`. Resolved against this target&#x27;s `go.mod`; use it to build a binary from a third-party package.
