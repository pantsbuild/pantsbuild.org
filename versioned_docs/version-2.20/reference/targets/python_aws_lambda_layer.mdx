...
See https://www.pantsbuild.org/2.20/docs/python/integrations/aws-lambda.
...
Any extra arguments to pass to the `pex3 venv create` invocation that is used to create the final zip file.
