...
## `kubectl_executable_search_paths`
...
Overrides the default value from the option `[kubectl].executable_search_paths` when this environment target is active.
...
Overrides the default value from the option `[uv].executable_search_paths` when this environment target is active.
...
Overrides the default value from the option `[uv].extra_env_vars` when this environment target is active.
