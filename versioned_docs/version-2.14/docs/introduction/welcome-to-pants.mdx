...
- Pants [ships](page:language-support) with support for [Python](../python/python-overview/index.mdx), [Go](../go/index.mdx), [Java](../java-and-scala/java-and-scala-overview.mdx), [Scala](../java-and-scala/java-and-scala-overview.mdx) and [Shell](../shell/shell-overview.mdx).
