...
If true, don&#x27;t use Buf when running `/home/josh/work/scie-pants/dist/pants fmt` and `/home/josh/work/scie-pants/dist/pants lint`.
...
If true, don&#x27;t use Buf when running `/home/josh/work/scie-pants/dist/pants lint`.
