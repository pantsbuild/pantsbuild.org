...
3. Find the commit SHA by running `git log master` or looking in GitHub: https://github.com/pantsbuild/pants/commits/master.
...
Each entry should have exactly one blank line between it. You can fix typos and tweak PR titles for clarity.
...
```
Subject: [dev release] pantsbuild.pants 2.2.0.dev0


The first weekly dev release for the 2.2.x series is now available [on PyPI](https://pypi.org/project/pantsbuild.pants/2.2.0.dev0/).

See [here](https://www.pantsbuild.org/v2.2/docs/release-notes-2-2) for a summary of the 2.2.x series so far and a link to a more detailed changelog.
...
```
Subject: [release candidate] pantsbuild.pants 2.2.0rc1


The second release candidate for 2.2.0 is now available [on PyPI](https://pypi.org/project/pantsbuild.pants/2.2.0rc0/).

See [here](https://www.pantsbuild.org/v2.2/docs/release-notes-2-2) for a summary of the 2.2.x series and a link to a more detailed changelog.
...
```
Subject: [stable release] pantsbuild.pants 2.2.0


The first stable release of the 2.2.x series is now available [on PyPI](https://pypi.org/project/pantsbuild.pants/2.2.0/).

See [here](https://www.pantsbuild.org/v2.2/docs/release-notes-2-2) for a summary of the 2.2.x series and a link to a more detailed changelog.

Thanks to all of the contributors to the 2.2.x series!
