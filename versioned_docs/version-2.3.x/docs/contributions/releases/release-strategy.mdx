...
Pants follows semantic versioning, along with using regular time-based dev releases. We follow a strict [Deprecation policy](../../release-notes/deprecation-policy.mdx).

:::note Tip: join the mailing group for release announcements
See [Community](/community/members).

Also see [Upgrade tips](../../release-notes/upgrade-tips.mdx) for suggestions on how to effectively upgrade Pants versions.
:::
...
Dev releases can include any changes, so long as they comply with the [Deprecation policy](../../release-notes/deprecation-policy.mdx).
