---
title: experimental_wrap_as_scala_sources
description: Allow files and sources produced by the targets specified by `inputs` to be consumed by rules that specifically expect a `ScalaSourceField`.
---
