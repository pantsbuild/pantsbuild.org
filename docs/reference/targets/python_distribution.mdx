...
See https://www.pantsbuild.org/v2.20/docs/python-distributions.
...
```
scie-pants-linux-x86_64 dependencies <python_distribution target address>
```
...
See https://www.pantsbuild.org/v2.20/docs/plugins-setup-py for how to write a plugin to dynamically generate kwargs.

</Field>

<div aria-hidden="true" style={ { visibility: 'hidden', height: 0 } }>
###### {#codegenerate_setupcode}
</div>
