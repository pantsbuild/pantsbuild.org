...
FYI: when running `/home/josh/work/scie-pants/dist/scie-pants-linux-x86_64 fmt lint ::`, there should be little performance benefit to using this flag. Pants will reuse the results from `fmt` when running `lint`.
