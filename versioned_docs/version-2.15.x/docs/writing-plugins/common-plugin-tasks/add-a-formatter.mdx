...
Start by skimming [Add a linter](./add-a-linter.mdx) to familiarize yourself with how linters work.
...
There are several ways for Pants to install your formatter. See [Installing tools](../the-rules-api/installing-tools.mdx).
