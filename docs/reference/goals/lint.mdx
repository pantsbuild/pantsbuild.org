...
- [The `fmt` goal](https://www.pantsbuild.org/2.32/reference/goals/fix will save the the result of formatters
  (code-editing tools that make only &#x22;syntactic&#x22; changes) back to the workspace.

- [The `fmt` goal](https://www.pantsbuild.org/2.32/reference/goals/fix will save the the result of fixers
...
- Documentation about linters for various ecosystems, such as:
  [Python](https://www.pantsbuild.org/2.32/docs/python/overview/linters-and-formatters), [Go](https://www.pantsbuild.org/2.32/docs/go),
  [JVM](https://www.pantsbuild.org/jvm/java-and-scala#lint-and-format), [Shell](https://www.pantsbuild.org/2.32/docs/shell),
  [Docker](https://www.pantsbuild.org/2.32/docs/docker#linting-dockerfiles-with-hadolint).
