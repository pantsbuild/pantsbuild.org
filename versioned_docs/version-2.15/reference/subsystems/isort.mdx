...
If true, don&#x27;t use isort when running `/home/josh/work/scie-pants/dist/pants fmt` and `/home/josh/work/scie-pants/dist/pants lint`.
...
If true, export a virtual environment with isort when running `/home/josh/work/scie-pants/dist/pants export`.
