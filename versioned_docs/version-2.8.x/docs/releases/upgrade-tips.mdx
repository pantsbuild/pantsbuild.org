...
You can add `update-build-files` to your [continuous integrationI](../using-pants/using-pants-in-ci.mdx) so that developers don't accidentally use reverted features:
