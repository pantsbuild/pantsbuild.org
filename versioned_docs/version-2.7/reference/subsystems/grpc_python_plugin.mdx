...
<Option
  ...
  toml_repr={`[grpc_python_plugin.url_platform_mapping]
key1 = val1
key2 = val2
...`}
  default_repr={`{\n  "linux_x86_64": "linux",\n  "macos_arm64": "macos",\n  "macos_x86_64": "macos"\n}`}
...
<Option
  cli_repr={`--grpc_python_plugin-use-unsupported-version=<UnsupportedVersionUsage>`}
