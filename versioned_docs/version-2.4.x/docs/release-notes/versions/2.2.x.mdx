...
- Added dependency inference for Python imports of Protobuf, along with Protobuf imports of Protobuf. See [Protobuf and gRPC](../../python/integrations/protobuf-and-grpc.mdx).
