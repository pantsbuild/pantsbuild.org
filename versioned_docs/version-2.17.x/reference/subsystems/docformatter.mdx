...
If true, don&#x27;t use docformatter when running `scie-pants-linux-x86_64 fmt` and `scie-pants-linux-x86_64 lint`.
...
If true, export a virtual environment with docformatter when running `scie-pants-linux-x86_64 export`.
